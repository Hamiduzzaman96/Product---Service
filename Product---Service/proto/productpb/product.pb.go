...
const file_proto_product_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x06 \x01(\tR\tcreatedAt2X\n" +
	"\x0eProductService\x12F\n" +
	"\x0eGetProductbyID\x12\x1a.product.GetProductRequest\x1a\x18.product.ProductResponseB#Z!Product---Service/proto/productpbb\x06proto3"
